...
using sensors_bus_id = struct sensors_bus_id
{
    short type;
    short nr;
};
...
using sensors_chip_name = struct sensors_chip_name
{
    char* prefix;
    sensors_bus_id bus;
    int addr;
...
using sensors_feature = struct sensors_feature;
...
using sensors_feature_type = enum sensors_feature_type
{
...
using sensors_subfeature_type = enum sensors_subfeature_type
{
...
using sensors_subfeature = struct sensors_subfeature
{
    char* name;
    int number;
