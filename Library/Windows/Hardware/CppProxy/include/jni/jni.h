...
using jobjectRefType = enum _jobjectType
{
    JNIInvalidRefType = 0,
    JNILocalRefType = 1,
    JNIGlobalRefType = 2,
 ...
 */
using JavaVMOption = struct JavaVMOption
{
    char* optionString;
    void* extraInfo;
};

using JavaVMInitArgs = struct JavaVMInitArgs
{
    jint version;
